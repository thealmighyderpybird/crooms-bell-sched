export default function Verified({ size }: { size: number }) {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fillRule="evenodd" width={size} height={size}>
