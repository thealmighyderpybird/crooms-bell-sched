...
import headerStyles from "~/components/root/header/header.module.css";
...
export default function AnnouncementsTrigger() {
    ...
    return <>
        <div className={ headerStyles.menuItem } onClick={() => setIsActive(!isActive)}>
            ...
            <div className={ headerStyles.subMenu } style={{ padding: "0.5rem", fontSize: "0.8rem" }}>Announcements</div>
        </div>
